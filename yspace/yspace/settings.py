...
SECRET_KEY = '^_ra2%wlee%odbfbl3bt9f*@)s63#2*o57_6w&=i@myyh)21*b'
...
ROOT_URLCONF = 'yspace.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR+"/yspace/templates",],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'yspace.wsgi.application'
